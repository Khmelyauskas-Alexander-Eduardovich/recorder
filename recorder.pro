...
UBUNTU_TRANSLATION_DOMAIN="audio-recorder.luksus"
...
aptest.commands = bash $$PWD/Recorder/tests/autopilot/run
aptest.depends  = sub-Recorder

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Recorder/tests/unit
unittest.depends  = sub-Recorder
